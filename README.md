...
3. docker build -t <path/to/Dockerfile>/<docker_image_name>
4. docker run -it -d --privileged -p 8080:8080 -p 6901:6901 -p 5901:5901 -v <your_local_workspace_dir>:/workspace <docker_image_name>
5. you can use --restart=always if you want the image to keep on booting with your machine
